...
module nios_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                  // rsp_mux:src_channel -> intel_niosv_m_0_data_manager_agent:write_rp_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                              // rsp_mux_001:src_channel -> intel_niosv_m_0_data_manager_agent:read_rp_channel
	...
	wire  [105:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> intel_niosv_m_0_dm_agent_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                // intel_niosv_m_0_dm_agent_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> intel_niosv_m_0_dm_agent_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                                // cmd_mux_002:src_valid -> pio_0_s1_agent:cp_valid
	wire  [105:0] cmd_mux_002_src_data;                                                 // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                // pio_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                              // cmd_mux_002:src_channel -> pio_0_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                        // cmd_mux_002:src_startofpacket -> pio_0_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                          // cmd_mux_002:src_endofpacket -> pio_0_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_003_src_data;                                                 // cmd_mux_003:src_data -> intel_niosv_m_0_timer_sw_agent_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                // intel_niosv_m_0_timer_sw_agent_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                              // cmd_mux_003:src_channel -> intel_niosv_m_0_timer_sw_agent_agent:cp_channel
	...
	wire  [105:0] pio_0_s1_agent_rp_data;                                               // pio_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] router_002_src_channel;                                               // router_002:src_channel -> intel_niosv_m_0_instruction_manager_wr_limiter:cmd_sink_channel
	...
	wire    [4:0] intel_niosv_m_0_instruction_manager_wr_limiter_cmd_src_channel;       // intel_niosv_m_0_instruction_manager_wr_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire    [4:0] rsp_mux_002_src_channel;                                              // rsp_mux_002:src_channel -> intel_niosv_m_0_instruction_manager_wr_limiter:rsp_sink_channel
	...
	wire    [4:0] intel_niosv_m_0_instruction_manager_wr_limiter_rsp_src_channel;       // intel_niosv_m_0_instruction_manager_wr_limiter:rsp_src_channel -> intel_niosv_m_0_instruction_manager_agent:write_rp_channel
	...
	wire    [4:0] router_003_src_channel;                                               // router_003:src_channel -> intel_niosv_m_0_instruction_manager_rd_limiter:cmd_sink_channel
	...
	wire    [4:0] intel_niosv_m_0_instruction_manager_rd_limiter_cmd_src_channel;       // intel_niosv_m_0_instruction_manager_rd_limiter:cmd_src_channel -> cmd_demux_003:sink_channel
	...
	wire    [4:0] rsp_mux_003_src_channel;                                              // rsp_mux_003:src_channel -> intel_niosv_m_0_instruction_manager_rd_limiter:rsp_sink_channel
	...
	wire    [4:0] intel_niosv_m_0_instruction_manager_rd_limiter_rsp_src_channel;       // intel_niosv_m_0_instruction_manager_rd_limiter:rsp_src_channel -> intel_niosv_m_0_instruction_manager_agent:read_rp_channel
	...
	wire    [4:0] cmd_demux_002_src0_channel;                                           // cmd_demux_002:src0_channel -> cmd_mux_001:sink2_channel
	...
	wire  [105:0] cmd_demux_002_src1_data;                                              // cmd_demux_002:src1_data -> cmd_mux_004:sink0_data
	wire          cmd_demux_002_src1_ready;                                             // cmd_mux_004:sink0_ready -> cmd_demux_002:src1_ready
	wire    [4:0] cmd_demux_002_src1_channel;                                           // cmd_demux_002:src1_channel -> cmd_mux_004:sink0_channel
	...
	wire    [4:0] cmd_demux_003_src0_channel;                                           // cmd_demux_003:src0_channel -> cmd_mux_001:sink3_channel
	...
	wire  [105:0] cmd_demux_003_src1_data;                                              // cmd_demux_003:src1_data -> cmd_mux_004:sink1_data
	...
	wire    [4:0] rsp_demux_001_src2_channel;                                           // rsp_demux_001:src2_channel -> rsp_mux_002:sink0_channel
	...
	wire    [4:0] rsp_demux_001_src3_channel;                                           // rsp_demux_001:src3_channel -> rsp_mux_003:sink0_channel
	...
	wire  [105:0] rsp_demux_004_src0_data;                                              // rsp_demux_004:src0_data -> rsp_mux_002:sink1_data
	wire          rsp_demux_004_src0_ready;                                             // rsp_mux_002:sink1_ready -> rsp_demux_004:src0_ready
	wire    [4:0] rsp_demux_004_src0_channel;                                           // rsp_demux_004:src0_channel -> rsp_mux_002:sink1_channel
	...
	wire  [105:0] rsp_demux_004_src1_data;                                              // rsp_demux_004:src1_data -> rsp_mux_003:sink1_data
	...
	wire    [4:0] intel_niosv_m_0_instruction_manager_wr_limiter_cmd_valid_data;        // intel_niosv_m_0_instruction_manager_wr_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	wire    [4:0] intel_niosv_m_0_instruction_manager_rd_limiter_cmd_valid_data;        // intel_niosv_m_0_instruction_manager_rd_limiter:cmd_src_valid -> cmd_demux_003:sink_valid
